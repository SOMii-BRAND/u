...
def login():
    ...
    print"\033[1;90m╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳╳"
    time.sleep(0.05)
    print "\033[1;91m[1]\x1b[1;93mNEW \x1b[1;92mSERIES (\x1b[1;94m24HOURS)"
    time.sleep(0.05)
...
def pilih_login():
    ...
    os.system('clear')
    print logo1
    print"\033[1;90m[1]\x1b[1;93mindia"
    time.sleep(0.05)
    print"\033[1;90m[2]\x1b[1;92mSomi brand YouTube Channel"
    time.sleep(0.05)
...
def action():
	...
	if FreakedDudex =='':
		...
		os.system("clear")
		print (logo2)
		print("\033[1;95m905,975,755,855,954, 897, 967, 937, 700, 727, 965, 786, 874, 856, 566, 590, 527, 568, 578")
		try:
			c = raw_input("\033[1;95m choose\x1b[1;97m code  : ")
			k="+91"
			idlist = ('.txt')
